...
class MessagesTest {
    ...
    fun `all locale keys are present for both locales`() {
        val knownKeys = listOf(
            ...
            "paysupport.text", "paysupport.empty", "paysupport.list", "paysupport.paymentRow", "paysupport.invalid",
            "paysupport.notFound", "paysupport.unavailable", "paysupport.submitted",
